...
export default class FullScreenContainer extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      currentMedia: props.mediaList[props.initialIndex || 0],
  ...
  _onActionButtonTapped() {
    ...
    if (onActionButton) {
      const { currentIndex, currentMedia, controlsDisplayed } = this.state;
      onActionButton(currentIndex);
    }
  }
